...
if(isset($_POST['submit_video'])){
   ...
   $extensions_arr = array("mp4","avi","3gp","mov","mpeg","ogg","pdf");
...
<form class="" action="video-upload.php" method="post" enctype="multipart/form-data">
  <div class="field is-grouped">
    ...
    <p class="control">
      <div class="buttons">
        <button id="submit_video" class="button is-success" type="submit" name="submit_video">Save changes</button>
...
<!-- Video upload succes message Start -->
...
<a href="http://localhost/php-mini-project/admin/controllers/video-view.php" class="button is-primary is-rounded is-pulled-right">View Uploaded Videos</a>
