...
$query_video_view = "SELECT * FROM tutorial_pdfs";
...
<html>
  <head>
    ...
    <title>Admin Dashboard - File View</title>
  ...
  <main class="column main" style="height: auto !important;">
    <nav class="breadcrumb is-small" aria-label="breadcrumbs">
      <ul>
        ...
        <li class="is-active">
          <a href="#" aria-current="page">Files Manage</a>
        </li>
      </ul>
    </nav>
    <div class="level">
      <div class="level-left">
        <div class="level-item">
          <div class="title has-text-info">
            <i class="fa fa-tachometer"></i> Files Manage
          </div>
        </div>
      </div>
    </div>
...
<table class="table is-fullwidth">
	...
	<thead>
		<tr>
			<th><abbr title="FILES ID">ID</abbr></th>
			<th>File Category</th>
      <th>File Name</th>
      <th>Description</th>
      <th>Action</th>
      ...
      <?php
        while ($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <td>
              <a href="http://localhost/php-mini-project/admin/controllers/file-edit.php" class="button is-warning" type="submit" name="submit_video">Edit</a>
              <a href="fileController.php?delete=<?php echo $row['id']; ?>" class="button is-danger" name="delete">Delete</a>
            </td>
          </tr>
        <?php endwhile; ?>
	</tbody>
