...
if(isset($_GET['edit'])){
  $video_id = $_GET['edit'];
  $query_video_edit = mysqli_query($con,"SELECT * FROM videos WHERE id=$video_id");
  $record = mysqli_fetch_array($query_video_edit);
  $name = $record['name'];
  $video_id= $record['id'];
  ...
  <main class="column main" style="height: auto !important;">
    <nav class="breadcrumb is-small" aria-label="breadcrumbs">
      <ul>
        ...
        <li class="is-active">
          <a href="#" aria-current="page">Video Edit</a>
        </li>
      </ul>
    </nav>
    <div class="level">
      <div class="level-left">
        <div class="level-item">
          <div class="title has-text-info">
            <i class="fa fa-tachometer"></i> Video Edit
          </div>
        </div>
      </div>
    </div>
...
<form class="" action="videoController.php" method="post" enctype="multipart/form-data">
  <input type="hidden" name="video_id" value="<?php echo $video_id; ?>">
  <div class="field is-grouped">
    <p class="control is-expanded">
      <input class="input" type="text" name="video_edit" value="<?php echo $name; ?>">
    </p>
    <p class="control">
      <div class="buttons">
