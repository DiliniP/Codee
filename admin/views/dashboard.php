...
<div class="columns">
  ...
  <main class="column main" style="height: auto !important;">
    ...
    <div class="columns is-multiline">
      ...
      <div class="column">
        <a href="http://localhost/php-mini-project/admin/controllers/file-upload.php"><div class="box notification is-info">
          <div class="heading"></div>
          <div class="title">File Upload ↑</div>
        </div>
      </div>
      <div class="column">
        <a href="http://localhost/php-mini-project/admin/controllers/video-upload.php"><div class="box notification is-danger">
          <div class="heading"></div>
